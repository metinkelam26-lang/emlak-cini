-- Guclu musteri-ilan eslesmelerini Aksiyon Bekleyenler kuyruguna ekler.
-- Puanlama tek otorite olan public.musteriye_uygun_ilanlar() tarafindan yapilir; burada yeniden hesaplanmaz.

DROP FUNCTION IF EXISTS public.aksiyon_bekleyenler(integer);

CREATE FUNCTION public.aksiyon_bekleyenler(
